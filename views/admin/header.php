...
<body>
    <header>
        ...
        <nav class="top-menu-bar">
            <div class="logo">
                <a href="<?= WEB_ROOT ?>home" target="__blank"><i class="fas fa-home"></i> <?= $site_info->title ?></a>
            </div>
                ...
                <ul class="nav-list">
                    ...
                    <li class="nav-item side-nav-item">
                        ...
                        <ul class="dropout">
                            <li class="nav-item">
                                ...
                                <a href="<?= WEB_ROOT ?>admin/projects/category" class="drop-nav-link nav-link">Categories</a>
                                <a href="<?= WEB_ROOT ?>admin/projects/tags" class="drop-nav-link nav-link">Tags</a>
                            </li>
                        </ul>
                        <!-- .dropout /-->
                    </li>
                    ...
                    <li class="nav-item side-nav-item">
                        <a href="<?= WEB_ROOT ?>admin/testimonials" class="nav-link">
                            <i class="fas fa-thumbtack"></i> <span>Testimonials</span>
                        </a>
                    </li>
                    <li class="nav-item side-nav-item">
                    ...
                    <li class="nav-item side-nav-item">
                        <a href="<?= WEB_ROOT ?>admin/todo" class="nav-link">
                            <i class="fas fa-pencil-alt"></i> <span>Todo</span>
                        </a>
                    </li>
                    <li class="nav-item side-nav-item">
                        <a href="<?= WEB_ROOT ?>admin/settings"" class=" nav-link">
                    ...
                    <li class="nav-item side-nav-item">
                        <a class="nav-link">
                            <i class="fas fa-arrow-circle-left"></i> <span>Collaps</span>
                        </a>
                    </li>
                    <!-- .nav-item .side-nav-item /-->
                </ul>
