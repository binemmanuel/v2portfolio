 ...
 */
function delete_project_modal(project_id) {
 ...
 * @param {Int} form
 */
function delete_media_modal(media_id, link_id) {
	body.classList.add("show-delete-modal");
	body.classList.remove("show-edit-modal");
...
function edit_media_modal(media_id, link_id, form, media_details) {
	...
	switch (media_details.type) {
		case "image":
			...
			display.setAttribute(
				"src",
				media_details.web_root + modal_hidden_input_link.value
			);
